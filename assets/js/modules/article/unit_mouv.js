$(document).ready(function() {
    ...
    var dataTable = $("#artilce_table").DataTable({
        ...
        order: [],
        ajax: {
            url: "api/article/fetch_unit_mouv/",
            type: "POST",
        ...
        buttons:
            [
                {
                    extend: 'excel',
                    title:" AOS SYSTEME UNIT MOVEMENT LIST -"+start,
                    titleAttr: 'Excel',
                    exportOptions: 
                            {
    ...
    $("#artilce_table").on("draw.dt", function () {
        ...
        $("#artilce_table").Tabledit({
            url: "api/article/edit_unit_mouv/",
            dataType: "json",
            buttons: {
                edit: {
 ...
 $('#formulaire').submit(function(e){        
        ...
        e.preventDefault(); 
        let libelle_unit_mouv=$('#libelle_unit_mouv').val() ;
        console.log('hlof') ;
           $.ajax({
              url: "api/article/insertunitmouv/",
              type: "POST",
              datatype:"json",    
              data:  { libelle_unit_mouv: libelle_unit_mouv},    
