                    ...
                    <div class="card">
                        ...
                        <form class="needs-validation" id="formulaire" >
                                            <div class="row">
                                               <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="article_name" class="form-label">LABEL LOCATION</label>
                                                        <input type="text" class="form-control" id="libelle_location"
                                                            placeholder="LABEL LOCATION"  required>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group d-grid ">
                                                            <button class="btn btn-primary btn-lg waves-effect" id="btnAdd" type="submit">ADD LOCATION</button>
                                                        </div>
                                                    </div>
