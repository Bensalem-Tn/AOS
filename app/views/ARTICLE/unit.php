                    ...
                    <div class="card">
                        ...
                        <form class="needs-validation" id="formulaire" >
                                            <div class="row">
                                               <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="article_name" class="form-label">LABEL UNIT</label>
                                                        <input type="text" class="form-control" id="libelle_unit"
                                                            placeholder="LABEL UNIT"  required>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group d-grid ">
                                                            <button class="btn btn-primary btn-lg waves-effect" id="btnAdd" type="submit">ADD UNIT</button>
                                                        </div>
                                                    </div>
