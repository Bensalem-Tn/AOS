                    ...
                    <div class="card">
                        ...
                        <form class="needs-validation" id="formulaire" >
                                            <div class="row">
                                               <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="article_name" class="form-label">LABEL PARTIAL</label>
                                                        <input type="text" class="form-control" id="libelle_partial"
                                            ...
                                            <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group d-grid ">
                                                            <button class="btn btn-primary btn-lg waves-effect" id="btnAdd" type="submit">ADD PARTIAL</button>
                                                        </div>
                                                    </div>
